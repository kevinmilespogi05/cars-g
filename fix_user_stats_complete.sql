-- Complete fix for user_stats table - addresses all current issues
...
-- Allow admins to manage all user stats (important for reward system)
...
SELECT COUNT(*) as total_rows FROM public.user_stats;
