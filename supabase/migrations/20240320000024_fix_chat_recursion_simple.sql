-- Simple fix for chat recursion issue
-- This migration only addresses the infinite recursion problem in chat_participants

-- Drop all existing problematic policies for chat tables
