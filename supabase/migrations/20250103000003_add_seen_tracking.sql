...
-- Update the existing is_read logic to be based on seen_at
-- A message is considered "read" if seen_at is not null
-- This maintains backward compatibility while adding the seen functionality
