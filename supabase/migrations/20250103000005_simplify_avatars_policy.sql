-- Simplify avatars RLS policy to allow all authenticated uploads
-- This migration creates a more permissive policy for avatar uploads
...
-- Also drop any policies that might have been created by the generic storage function
