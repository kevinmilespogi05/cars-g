  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Stats Overview (clickable filters) - Responsive Grid: 2 mobile / 3 tablet / 4 desktop */}
        ...
        <div className="bg-white/90 backdrop-blur rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          {loading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 px-4 py-6">
              {filtered.map((report) => {
                ...
                <div
                  ...
                  className={`bg-white rounded-lg shadow-sm overflow-hidden cursor-pointer group border transition-colors ${
                    report.priority === 'high' ? 'border-red-200 hover:ring-1 hover:ring-red-200' : report.priority === 'medium' ? 'border-amber-200 hover:ring-1 hover:ring-amber-200' : 'border-emerald-200 hover:ring-1 hover:ring-emerald-200'
                  }`}
                >
                    ...
                    {Array.isArray(report.images) && report.images.length > 0 ? (
                      <div className="w-full" style={aspectStyle}>
                        <img
                          ...
                          style={{ display: 'block', aspectRatio: aspectStyle ? undefined : '1 / 1' }}
                        />
                      </div>
                    ) : (
                  ...
                  <div className="p-3">
                    ...
                    {report.case_number && <div className="text-xs text-gray-500">ID: <span className="font-medium text-gray-700">{report.case_number}</span></div>}
                  </div>
                </div>
                );
              })}
