      ...
      */}
      <div className="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-screen-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr_1fr] gap-5">
          ...
          {/* LEFT COLUMN: Sidebar Navigation - Hidden on mobile, sticky on desktop */}
          <aside className="hidden lg:block lg:sticky lg:top-20 lg:self-start order-1">
            <SideNav />
          </aside>

          {/* CENTER COLUMN: Main Content (Announcements + Reports List) */}
          <main className="order-2 lg:order-2 space-y-5">
            {/* Announcement Banner */}
            <div>
              <AnnouncementBanner />
            </div>
          ...
          <aside className="hidden md:block lg:sticky lg:top-20 lg:self-start order-3 space-y-5">
            {/* Emergency Contacts */}
            <EmergencyContacts />
          ...
          <div className="md:hidden order-4 space-y-5">
