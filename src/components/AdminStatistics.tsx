...
export function AdminStatistics() {
  ...
  const exportStatistics = async () => {
    ...
    try {
      ...
      const csvData = [
        // Title and metadata
        ['Bantay SP Admin Statistics Dashboard'],
        ...
        // Footer
        ['End of Report'],
        ['Generated by Bantay SP Admin Dashboard'],
          ...
          <div className="mt-4 sm:mt-6 grid grid-cols-2 gap-3 sm:gap-5 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-3 sm:p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <div className="h-8 w-8 sm:h-12 sm:w-12 rounded-md bg-red-500 flex items-center justify-center">
                      <AlertTriangle className="h-4 w-4 sm:h-6 sm:w-6 text-white" />
                    </div>
                  </div>
                  <div className="ml-3 sm:ml-5 w-0 flex-1">
