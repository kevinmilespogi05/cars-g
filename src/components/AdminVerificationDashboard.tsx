    ...
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-4xl font-bold text-blue-600">ID Verification</h1>
              ...
              {selectedRequest.status === 'pending' && (
                <>
                  ...
                  <motion.button
                    ...
                    disabled={processing === selectedRequest.id}
                    className="px-6 py-3 text-white bg-green-500 hover:bg-green-600 rounded-xl font-semibold shadow-lg hover:shadow-xl disabled:opacity-50 transition-all"
                  >
                    Approve
                  </motion.button>
                </>
