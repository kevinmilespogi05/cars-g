-- IMMEDIATE FIX FOR CHAT RECURSION - Run this in your Supabase SQL Editor
-- This script completely removes all problematic policies and creates simple, safe ones
...
-- Test that the policies were created successfully
SELECT 'Chat recursion fix applied successfully' as status;
...
AND tablename IN ('chat_rooms', 'chat_participants', 'chat_messages', 'message_reactions', 'typing_indicators')
