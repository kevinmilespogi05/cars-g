...
-- Drop all chat_participants policies that might cause recursion
...
-- Also drop related policies that might reference chat_participants
...
SELECT 
    'New chat_participants policies:' as info,
    policyname,
    cmd,
    qual,
    with_check
