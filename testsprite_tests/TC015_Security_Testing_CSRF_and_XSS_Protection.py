...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Sign In' to access login form for authentication.
        ...
        # -> Attempt to submit form data without CSRF token to verify if submission is rejected.
        frame = context.pages[-1]
        # Click 'Report Issue' to open the report submission form
        elem = frame.locator('xpath=html/body/div/div/div/aside/div/div[3]/div[2]/div/div/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Close the 'Welcome Guide' modal to enable interaction with the report submission form.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test failed: Submission without CSRF token was not rejected as expected, indicating missing CSRF protection and potential security vulnerability.")
